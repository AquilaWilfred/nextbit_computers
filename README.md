...
| **Catalogue API Docs** | [https://nextbit-catalogue.onrender.com/scalar](https://nextbit-catalogue.onrender.com/scalar) | Interactive Swagger UI for Python endpoints. |
| **Gateway Swagger UI** | [https://nextbit-gateway.onrender.com/scalar](https://nextbit-gateway.onrender.com/scalar) | OpenAPI schema docs for Rust/Axum engine. |
